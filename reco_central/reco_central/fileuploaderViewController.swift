...
class fileuploaderViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "tonext" {
            let nextpageVC = segue.destination as! fileuploadermoveViewController
            let user = username;
            let pass = password;
        ...
        if segue.identifier == "toback" {
            let backpageVC = segue.destination as! fileuploadermoveViewController
            let user = username;
            let pass = password;
            let next = nextpagenum;
            print("next:")
